          ...
          <div className="lg:col-start-2">
            ...
            {order._isPaid ? (
              <p className="mt-2 text-base text-muted-foreground ">
                ...
                download below. we&apos;ve sent receipt and order details to{" "}
            ...
            <div className="mt-16 text-sm font-medium">
              ...
              <ul className="mt-6 border-t border-gray-200 text-sm font-medium text-muted-foreground">
              ...
              <div className="space-y-6 border-t border-gray-200 pt-2 text-sm font-medium text-muted-foreground">
                ...
                <div className="flex items-center text-base justify-between border-t border-gray-200 pt-6 text-gray-900">
                  <p>Total</p>
